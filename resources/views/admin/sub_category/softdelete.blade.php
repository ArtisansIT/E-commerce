                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  <form id="form-delete-{{ $data->id }}"  method="get" style="display: none;" 
                                    action=" {{ route('admin.SubCategory.parmanent_delete',$data->id) }} ">
                                    {{-- {{ csrf_field() }}
                                    {{ method_field('DELETE') }} --}}
                                ...
                                <td><a href="{{ route('admin.SubCategory.softdelete.restore',$data->id) }}" class="btn btn-sm btn-info"> Restore</a></td>
