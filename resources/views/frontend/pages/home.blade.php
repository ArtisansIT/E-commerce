                    ...
                    <div class="main-sidebar hot-deals-wrap mb-30">
                        ...
                        <div class="deals-carousel-active slick-padding slick-arrow-style">
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img7.jpg')}}" class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img13.jpg')}}" class="img-sec" alt="">
                                    </a>
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img3.jpg')}}" class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img4.jpg')}}" class="img-sec" alt="">
                                    </a>
                                    <div class="product-label">
                                        <span>hot</span>
                                    </div>
                            ...
                            <div class="product-item fix">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="{{ asset('frontend/assets/img/product/product-img5.jpg')}}" class="img-pri" alt="">
                                        <img src="{{ asset('frontend/assets/img/product/product-img1.jpg')}}" class="img-sec" alt="">
                                    </a>
                                    <div class="product-label">
                                        <span>hot</span>
                                    </div>
                        ...
                        <div class="category-carousel-active row" data-row="4">
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img1.jpg')}}" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                                        <h4><a href="product-details.html">Virtual Product 01</a></h4>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img3.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                                        <h4><a href="product-details.html">Virtual Product 01</a></h4>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img4.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                                        <h4><a href="product-details.html">Virtual Product 01</a></h4>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img5.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                                        <h4><a href="product-details.html">Virtual Product 01</a></h4>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img6.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                                        <h4><a href="product-details.html">Virtual Product 01</a></h4>
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img10.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                            ...
                            <div class="col">
                                <div class="category-item">
                                    <div class="category-thumb">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/assets/img/product/product-img12.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="category-content">
                    ...
                    <div class="main-sidebar blog-area mb-24">
                        ...
                        <div class="blog-carousel-active">
                            <div class="blog-item">
                                <div class="blog-thumb img-full fix">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('frontend/assets/img/blog/img_blog1.jpg')}}" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="blog-item">
                                <div class="blog-thumb img-full fix">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('frontend/assets/img/blog/img_blog2.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="blog-content">
                        ...
                        <div class="testimonial-carousel-active slick-dot-style">
                            <div class="testimonial-item text-center">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/testimonial/team_member1.jpg')}}" alt="">
                                </div>
                            ...
                            <div class="testimonial-item text-center">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/testimonial/team_member2.jpg')}}" alt="">
                                </div>
                                <div class="testimonial-content">
                                    <h3><a href="#">Elizabeth Taylor</a></h3>
                                    <p>Etiam rhoncus congue arcu sed interdum. Cras dolor diam, accumsan eu
                            ...
                            <div class="testimonial-item text-center">
                                <div class="testimonial-thumb">
                                    <img src="{{ asset('frontend/assets/img/testimonial/team_member3.jpg')}}" alt="">
                                </div>
                                <div class="testimonial-content">
                                    <h3><a href="#">Elizabeth Taylor</a></h3>
                                    <p>Etiam rhoncus congue arcu sed interdum. Cras dolor diam, accumsan eu
                ...
                <div class="feature-category-area mt-md-70">
                    ...
                    <div class="featured-carousel-active slick-padding slick-arrow-style">
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img src="{{ asset('frontend/assets/img/product/product-img1.jpg')}}" class="img-pri" alt="">
                                    <img src="{{ asset('frontend/assets/img/product/product-img2.jpg')}}" class="img-sec" alt="">
                                </a>
                                <div class="product-label">
                                    <span>hot</span>
                                </div>
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img src="{{ asset('frontend/assets/img/product/product-img5.jpg')}}" class="img-pri" alt="">
                                    <img src="{{ asset('frontend/assets/img/product/product-img6.jpg')}}" class="img-sec" alt="">
                                </a>
                                <div class="product-label">
                                    <span>hot</span>
                                </div>
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img src="{{ asset('frontend/assets/img/product/product-img7.jpg')}}" class="img-pri" alt="">
                                    <img src="{{ asset('frontend/assets/img/product/product-img8.jpg')}}" class="img-sec" alt="">
                                </a>
                                <div class="product-label">
                                    <span>hot</span>
                                </div>
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img src="{{ asset('frontend/assets/img/product/product-img9.jpg')}}" class="img-pri" alt="">
                                    <img src="{{ asset('frontend/assets/img/product/product-img10.jpg')}}" class="img-sec" alt="">
                                </a>
                                <div class="product-label">
                                    <span>hot</span>
                                </div>
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details.html">
                                    <img src="{{ asset('frontend/assets/img/product/product-img11.jpg')}}" class="img-pri" alt="">
                                    <img src="{{ asset('frontend/assets/img/product/product-img12.jpg')}}" class="img-sec" alt="">
                                </a>
                                <div class="product-label">
                                    <span>hot</span>
                                </div>
                                ...
                                <div class="category-carousel-active row" data-row="4">
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img7.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">Virtual Product 01</a></h4>
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img8.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">grouped Product</a></h4>
                                ...
                                <div class="category-carousel-active row" data-row="4">
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img14.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img13.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">affiliate Product</a></h4>
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img9.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                ...
                                <div class="category-carousel-active row" data-row="4">
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img15.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">grouped Product</a></h4>
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img11.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">download Product</a></h4>
                                    ...
                                    <div class="col">
                                        <div class="category-item">
                                            <div class="category-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('frontend/assets/img/product/product-img16.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="category-content">
                                                <h4><a href="product-details.html">simple Product 01</a></h4>
            ...
            <div class="col-12">
                <div class="brand-active slick-padding slick-arrow-style">
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br1.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br2.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br3.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br4.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br5.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br6.png')}}" alt=""></a>
                    </div>
                    <div class="brand-item text-center">
                        <a href="#"><img src="{{ asset('frontend/assets/img/brand/br4.png')}}" alt=""></a>
                    </div>
