                    ...
                    <div class="main-header-inner">
                        <div class="category-toggle-wrap">
                            ...
                            <nav class="category-menu hm-1">
                                <ul>
                                    @if (count($allcategory) < 2)

                                     {{-- if Only one Category exists in the database    --}}
                                     
                                    @foreach ($allcategory->first()->subcategories->all() as $item)
                                    ...
                                    <li class="menu-item-has-children"><a href="shop-grid-left-sidebar.html"> {{ $cat->name }}</a>
                                        <!-- Mega cat Menu Start -->
                                        
                                        <ul class="category-mega-menu">
                                                @foreach ($cat->subcategories->all() as $item)
                                            <li class="menu-item-has-children">
                                                
                                                <ul>
                                                    <li><a href="shop-grid-left-sidebar.html">{{ $item->name }}</a></li>
